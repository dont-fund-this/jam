# considerate thirds, name

the two most important things for an app are the name and icon
- thomas

`code with pals`
any part i had in naming that is on the higher side of my curve ( like, way )

`christophe's ultimate layout thingy`
...
for the rest of us its like third
if you name things so it sounds like it comes with a side of penis salad
maybe a gated community? for when they come to push you against the wall
tag [no-ass-burgers]
tag [no-penis-salad]
...
but then many just sorta drift to the bottom. repeat
tag [scorpion-frog-part-3]

avoid logo that look like
lumpy pockets or hot dogs
tag [no-hotdog-not-hotdog]
tag [no-hotdog-raw-hotdog]
tag [no-hotdog-not-rawdog]
tag [no-hotdog-raw-rawdog]
